...
export default function Category() {
  ...
  useEffect(() => {
    axios
      .get(
        ...
        }/api/v1/categories/?limit=5&offset=${parseInt(
  ...
  const handleChangePage = (event, newPage) => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_SERVER_PATH}/api/v1/categories/?limit=${
  ...
  const handleSearch = () => {
    axios
      .get(
        `${process.env.REACT_APP_SERVER_PATH}/api/v1/categories/?search=${search}`
      )
      .then((res) => {
        setRows(res.data.results);
      });
      ...
      <div class="container-fluid">
        <div className="search-container search-res-cont">
          <div className="taste-btn-container width-fill ">
            <Link
              to="/administration/category/new-category"
                      ...
                      <TableRow key={row.id}>
                        ...
                        <TableCell className="table-body-text" align="center">
                          <Tooltip title="Edit" placement="top-start">
                            <IconButton
                              component={Link}
                              to={`/administration/category/edit/${row.id}`}
                              aria-label="file"
