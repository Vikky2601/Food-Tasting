...
export default function ProductGroup() {
  ...
  useEffect(() => {
    axios
      .get(
        ...
        }/api/v1/product_groups/?limit=5&offset=${parseInt(
  ...
  const handleChangePage = (event, newPage) => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_SERVER_PATH}/api/v1/product_groups/?limit=${
  ...
  const handleSearch = () => {
    axios
      .get(
        `${process.env.REACT_APP_SERVER_PATH}/api/v1/product_groups/?search=${search}`
      )
      .then((res) => {
        setRows(res.data.results);
      });
      ...
      <div class="container-fluid">
        <div className="search-container search-res-cont">
          <div className="taste-btn-container width-fill ">
            <Link
              to="/administration/product-group/new-product-group"
                      ...
                      <TableRow key={row.id}>
                        ...
                        <TableCell className="table-body-text" align="center">
                          <Tooltip title="Edit" placement="top-start">
                            <IconButton
                              component={Link}
                              to={`/administration/product-group/edit/${row.id}`}
                              aria-label="file"
