...
const NewTastingRegion = () => {
  ...
  const onFormSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(
        `${process.env.REACT_APP_SERVER_PATH}/api/v1/regions/`,
        payload
      );
      setOpen(true);
      setTimeout(() => {
    ...
    <form onSubmit={onFormSubmit}>
      ...
      >
        <Snackbar
          ...
          message="Added A New Tasting Region"
        ...
        <div className=" HOME attribute-box">
          <div className="attribute-box-1 table-margin box-shadow">
            <div className="attribute-box-1-heading row">
              ...
              <h4 className="col-9">Add a new Tasting Region</h4>
              <br />
            </div>
...
export default NewTastingRegion;
