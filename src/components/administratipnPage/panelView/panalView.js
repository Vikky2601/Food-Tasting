...
export default function PanelView() {
  ...
  useEffect(() => {
    axios
      .get(
        ...
        }/api/v1/panel_views/?limit=5&offset=${parseInt(
  ...
  const handleChangePage = (event, newPage) => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_SERVER_PATH}/api/v1/panel_views/?limit=${
  ...
  const handleSearch = () => {
    axios
      .get(
        `${process.env.REACT_APP_SERVER_PATH}/api/v1/panel_views/?search=${search}`
      )
      .then((res) => {
        setRows(res.data.results);
      });
      ...
      <div class="container-fluid">
        <div className="search-container search-res-cont">
          <div className="taste-btn-container width-fill ">
            <Link
              to="/administration/panel-view/new-panel-view"
                      ...
                      <TableRow key={row.id}>
                        ...
                        <TableCell className="table-body-text" align="center">
                          <Tooltip title="Edit" placement="top-start">
                            <IconButton
                              component={Link}
                              to={`/administration/panel-view/edit/${row.id}`}
                              aria-label="file"
