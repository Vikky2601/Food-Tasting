...
const EditPanelView = () => {
  ...
  const handleDelete = async () => {
    await axios.delete(
      `${process.env.REACT_APP_SERVER_PATH}/api/v1/panel_views/${id}`
    );
    setSnackDel(true);
    setTimeout(() => {
      history.push("/administration/panel-view");
    }, 1500);
  };
        ...
        <div className=" HOME attribute-box">
          <div className="attribute-box-1 table-margin box-shadow">
            <div className="attribute-box-1-heading row">
              ...
              <h4 className="col-9">Edit Panel View (#ID {id})</h4>
              <br />
            </div>
            <div className="attribute-box-1-editBox row ">
              <p className="col-md-5 col-sm-12">Panel View</p>
              <br />
              <input
